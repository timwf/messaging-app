    ...
    return (      
        <div className="message-board">
             {props.state.userNames.length === 1 ? 
                  ...
                  <p className="message-sent-bubble">Hi {props.userName.userName} <span role="img">🙏</span>.  You are the only one here! <span role="img">😬</span> You can talk to yourself but it might not be much fun... invite a friend to join - share this <a href="https://tim-fowler-message.herokuapp.com/" role="img">link</a> <br/> <br/><i>This app has been created with <span>💘</span> by <a href="https://github.com/timwf">Timothy Williams Fowler</a></i></p>
                  </div>  
             : <p></p>}
